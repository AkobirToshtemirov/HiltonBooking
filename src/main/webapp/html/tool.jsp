                  ...
                  <div class="reservations_block">
                    ...
                    <c:choose>
                      ...
                      <%-- <c:when test="${tool.equals('newUsers')}">
                        ...
                        <c:when
                          test="${tool.equals('newBookings') || tool.equals('approvedBookings') || tool.equals('checkedInBookings') || tool.equals('checkedOutBookings') || tool.equals('cancelledBookings')}">
                          ...
                          <div class="reservation_headline">
                            ...
                            <c:if
                              test="${tool.equals('approvedBookings') || tool.equals('checkedInBookings') || tool.equals('checkedOutBookings')}">
                            ...
                            <c:if test="${element.status.equals('APPROVED')}">
                              <div class="reservation">
                                ...
                                <div class="bar delete_btn_bar">
                                  <form action="booking-details" method="get">
                                    <input type="hidden" name="booking-id" value="${element.id}" />
                                    <button type="submit" class="check_btn take_action_btn checked_btn">Check
                                      In</button>
                                  </form>
                                </div>
                              </div>
