  ...
  <section id="home">
    <div class="container">
      <div class="overview_main">
        <div class="overview">
          <h1>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus fugit nulla sit facilis ipsum
            iure suscipit! Alias voluptatum architecto possimus?</h1>
        </div>
      ...
      <div class="about_main">
        <div class="text_block">
          ...
          <div class="text_inner">
            <h3>About Us</h3>
            <h1>Hilton, hotel like your home</h1>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempora eaque nisi distinctio sapiente labore
              totam quas explicabo tempore, ut dolores earum beatae provident quod, libero placeat quibusdam fuga
              obcaecati mollitia voluptatum veniam? Nam facilis accusamus natus tempora ad fugit alias?</p>
          </div>
            ...
            <form action="message" method="post">
              <div class="basic_info">
                <label for="contact_name">
                  <p>Your name</p>
                  <input class="top" type="text" name="name" id="contact_name">
                </label>
                <label for="contact_email">
                  <p>Your email</p>
                  <input id="contact_email" class="top" type="email">
                </label>
              </div>
              <label for="contact_phone">
                <p>Phone number</p>
                <input id="contact_phone" class="top" type="number">
              </label>
              <label for="contact_message">
                <p>Message</p>
                <textarea class="top" name="message" id="contact_message" cols="30" rows="10"></textarea>
              </label>
